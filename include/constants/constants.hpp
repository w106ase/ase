...
namespace constants
{
  ...
  const double gbm_barrier_param_update = 1.1; /*!< General barrier method barrier parameter update */
  const double gbm_max_iter = 200; /*!< General barrier method maximum iterations */
  const double gbm_sub_opt_thresh = 1.0e-12; /*!< General barrier method suboptimality threshold */
  const double gdm_max_iter = 200; /*!< General descent method maximum iterations */
  const double gdm_norm2_grad_thresh = 1.0e-12; /*!< General descent method norm-squared gradient threshold */
  const double gdm_diff_f_obj_thresh = 1.0e-12; /*!< General descent method difference in objective function threshold */
  const double gdm_rel_dx_norm2_thresh = 1.0e-12; /*!< General descent method relative difference threshold */
